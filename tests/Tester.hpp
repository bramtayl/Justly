...
struct Tester : public QObject {
 ...
 private slots:
  ...
  static void test_musicxml_inline_error_data();
  ...
  static void test_read_zip_entry_error_data();
  void test_read_zip_entry_error() const;
  ...
  static void test_voice_velocity_ratio_cells_data();
  void test_voice_velocity_ratio_cells();
