...
private slots:
  ...
  void test_delete_cell_template() const;
  void test_delete_cell_template_data() const;

  void test_delete_3_groups_template() const;
  void test_delete_3_groups_template_data() const;

  void test_paste_cell_template() const;
  void test_paste_cell_template_data() const;

  void test_cut_paste_cell_template() const;
  void test_cut_paste_cell_template_data() const;

  void test_paste_3_groups_template() const;
  void test_paste_3_groups_template_data() const;

  void test_paste_truncate_template() const;
  void test_paste_truncate_template_data() const;

  void test_paste_recycle_template() const;
  void test_paste_recycle_template_data() const;
  ...
  void test_insert_rows_template() const;
  void test_insert_rows_template_data() const;

  void test_delete_rows_template() const;
  void test_delete_rows_template_data() const;

  void test_paste_rows_template() const;
  void test_paste_rows_template_data() const;

  void test_bad_paste_template();
  void test_bad_paste_template_data() const;
