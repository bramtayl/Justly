...
void connect_navigate_chord_action(QAction& action, QObject& context,
  ...
  QObject::connect(
      ...
      [&song_menu_bar, &song_widget, &piano_roll_widget, delta]() -> auto {
        ...
        add_replace_table(
            song_menu_bar, song_widget, switch_table.delegate.current_row_type,
            get_parent_chord_number(switch_table) + delta, piano_roll_widget);
      });
}

void rebuild_piano_roll_scene(PianoRollWidget& widget) {
  rebuild_scene(
      widget, widget.song_widget, widget.piano_roll_scene, widget.axis_scene,
...
void stop_piano_roll_playhead(PianoRollWidget& widget) {
  stop_playhead(
      widget.piano_roll_scene, widget.axis_scene, widget.song_widget.song,
...
SongEditor::SongEditor()
  ...
  connect_switch_to_table(song_menu_bar.view_menu.back_to_chords_action, *this,
                          song_menu_bar, song_widget, piano_roll_widget,
                          RowType::chord_type);
  connect_switch_to_table(song_menu_bar.view_menu.edit_pitched_voices_action,
                          *this, song_menu_bar, song_widget, piano_roll_widget,
                          RowType::pitched_voice_type);
  connect_switch_to_table(song_menu_bar.view_menu.edit_unpitched_voices_action,
                          *this, song_menu_bar, song_widget, piano_roll_widget,
  ...
  QObject::connect(&show_piano_roll_action, &QAction::toggled, &piano_roll_dock,
  ...
  QObject::connect(&song_menu_bar.view_menu.zoom_in_action, &QAction::triggered,
                   &piano_roll_widget_ref, [&piano_roll_widget_ref]() -> auto {
  ...
  add_replace_table(song_menu_bar, song_widget, RowType::unpitched_voice_type,
                    -1, piano_roll_widget);
