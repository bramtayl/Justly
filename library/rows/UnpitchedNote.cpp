...
auto UnpitchedNote::get_closest_midi(
    ...
    int /*note_number*/) const -> std::optional<short> {
...
void UnpitchedNote::set_data(const int column_number, const QVariant &new_value) {
  switch (static_cast<UnpitchedNoteColumn>(column_number)) {
  case UnpitchedNoteColumn::number_of_unpitched_note_columns:
    Q_UNREACHABLE();
  case UnpitchedNoteColumn::unpitched_note_voice_number_column:
...
void UnpitchedNote::column_to_xml(xmlNode &node, const int column_number) const {
  switch (static_cast<UnpitchedNoteColumn>(column_number)) {
  case UnpitchedNoteColumn::number_of_unpitched_note_columns:
    Q_UNREACHABLE();
  case UnpitchedNoteColumn::unpitched_note_voice_number_column:
