...
UnpitchedVoice::UnpitchedVoice() : Voice() {
  program = "Standard";
}
...
void UnpitchedVoice::set_data(const int column_number, const QVariant &new_value) {
  switch (static_cast<UnpitchedVoiceColumn>(column_number)) {
  case UnpitchedVoiceColumn::number_of_unpitched_voice_columns:
    Q_UNREACHABLE();
  case UnpitchedVoiceColumn::unpitched_voice_name_column:
...
void UnpitchedVoice::column_to_xml(xmlNode &node, const int column_number) const {
  switch (static_cast<UnpitchedVoiceColumn>(column_number)) {
  case UnpitchedVoiceColumn::number_of_unpitched_voice_columns:
    Q_UNREACHABLE();
  case UnpitchedVoiceColumn::unpitched_voice_name_column:
