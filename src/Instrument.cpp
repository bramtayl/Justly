...
auto Instrument::get_all_instruments() -> std::vector<Instrument> & {
  static std::vector<Instrument> all_instruments = {
      ...
      // Instrument("5th Saw Wave Expressive", "fifth_saw_wave_expr", 17, 86,
      // 1),
      ...
      // Instrument("Brass Section Expressive", "brass_section_expr", 17, 61,
      // 37),
      ...
      // Instrument("Church Organ 2 Expressive", "church_org_2_expr", 18, 19,
      // 65),
      ...
      // Instrument("Detuned Org. 1 Expressive", "detuned_org_1_expr", 18, 16,
      // 79), Instrument("Detuned Org. 2 Expressive", "detuned_org_2_expr", 18,
      // 17, 80),
      ...
      // Instrument("Drawback Organ Expressive", "drawback_organ_expr", 17, 16,
      // 87),
      ...
      // Instrument("French Horns Expressive", "french_horns_expr", 17, 60,
      // 104),
      ...
      // Instrument("Hmn. Mute Tpt. Expressive", "hmn_mute_tpt_expr", 17, 59,
      // 124),
      Instrument("Honky-Tonk Piano", "honky_tonk_piano", 0, 3, 125),
      Instrument("Ice Rain", "ice_rain", 0, 96, 126),
      // Instrument("It. Accordion Expressive", "it_accordion_expr", 18, 21,
      // 127),
      ...
      // Instrument("Strings Fast Expressive", "strings_fast_expr", 17, 48,
      // 225),
      Instrument("Strings Fast", "strings_fast", 0, 48, 226),
      Instrument("Strings Pizzicato", "strings_pizzicato", 0, 45, 227),
      // Instrument("Strings Slow Expressive", "strings_slow_expr", 17, 49,
      // 228),
      Instrument("Strings Slow", "strings_slow", 0, 49, 229),
      // Instrument("Strings Trem Expressive", "strings_trem_expr", 17, 44,
      // 230),
      ...
      // Instrument("Syn. Strings 1 Expressive", "syn_strings_1_expr", 17, 50,
      // 234), Instrument("Syn. Strings 2 Expressive", "syn_stirngs_2_expr", 17,
      // 51, 235), Instrument("Synth Bass 1 Expressive", "synth_bass_1_expr",
      // 17, 62, 236),
      Instrument("Synth Bass 1", "synth_bass_1", 0, 38, 237),
      // Instrument("Synth Bass 2 Expressive", "synth_bass_2_expr", 17, 63,
      // 238),
      ...
      // Instrument("Synth Brass 3 Expressive", "synth_brass_3_expr", 18, 62,
      // 244),
      Instrument("Synth Brass 3", "synth_brass_3", 8, 62, 245),
      // Instrument("Synth Brass 4 Expressive", "synth_brass_4_expr", 18, 63,
      // 246),
      ...
      // Instrument("Violins Fast Expressive", "violins_fast_expr", 21, 48,
      // 285), Instrument("Violins Fast", "violins_fast", 20, 48, 286),
      // Instrument("Violins Pizzicato", "violins_pizzicato", 20, 45, 287),
      // Instrument("Violins Slow Expressive", "violins_slow_expr", 21, 49,
      // 288), Instrument("Violins Slow", "violins_slow", 20, 49, 289),
      // Instrument("Violins Trem Expressive", "violins_trem_expr", 21, 44,
      // 290), Instrument("Violins Tremolo", "violins_tremolo", 20, 44, 291),
      // Instrument("Violins2 Fast Expressive", "violins2_fast_expr", 26, 48,
      // 292), Instrument("Violins2 Fast", "violins2_fast", 25, 48, 293),
      // Instrument("Violins2 Pizzicato", "violin2_pizzicato", 25, 45, 294),
      // Instrument("Violins2 Slow Expressive", "violins2_slow_expr", 26, 49,
      // 295), Instrument("Violins2 Slow", "violins2_slow", 25, 49, 296),
      // Instrument("Violins2 Trem Expressive", "violins2_trem_expr", 26, 44,
      // 297), Instrument("Violins2 Tremolo", "violins2_tremolo", 25, 44, 298),
