...
auto Editor::get_control_value(StartingFieldId value_type) const
    -> QVariant {
  switch (value_type) {
...
void Editor::set_control_no_signals(
...
void Editor::initialize_control(
    StartingFieldId value_type) const {
  set_control_no_signals(
