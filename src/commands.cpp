...
CellChange::CellChange(ChordsModel &chords_model_input, const QModelIndex &index_input,
...
Remove::Remove(ChordsModel &chords_model_input, int position_input, size_t rows_input,
...
InsertEmptyRows::InsertEmptyRows(ChordsModel &chords_model_input, int position_input,
                                 int rows_input,
                                 const QModelIndex &parent_index_input,
                                 QUndoCommand *parent_input)
    : QUndoCommand(parent_input),
...
void InsertEmptyRows::redo() { chords_model.insertRows(position, rows, parent_index); }

void InsertEmptyRows::undo() { chords_model.removeRows(position, rows, parent_index); }
