...
public:
  ...
  const std::vector<Instrument> instruments = {
    ...
    Instrument("Grand Piano", "marimba", 0, 12, 142),
    ...
    // Instrument("OldMarching Tenor", "old_marching_tenor", 128, 95, 153),
    // Instrument("OldMarchingBass", "old_marching_bass", 128, 57, 154),
